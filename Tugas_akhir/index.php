        ...
        <div class="container mb-auto">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <button type="button" class="btn btn-success" onclick="window.location='rajaongkir.php'">
                        <i class="fa fa-plus"></i> rajaongkir
                    </button>
                </div>
                <div class="input-group-prepend col">
                    <input class="form-control-sm py-2 border-right-0 border" type="search" value="search"
                    ...
                    <tbody id="userlist">
                        ...
                        foreach ($result as $value) {
                            ...
                            <tr>
                                ...
                                <td nowrap>
                                    <button type="button" onclick="showModalEdt(<?php echo $value['id']; ?>);"
                                            class="btn btn-success btn-sm">
                                        <i class="fa fa-edit"></i> Edit
                                    </button>
                                    <button type="button" onclick="showModalDel(<?php echo $value['id']; ?>,
                                                '<?php echo $value['fullname']; ?>');" class="btn btn-danger btn-sm">
